...
public class HibernateNonEntityMetadata implements Metadata {
	...
	public HibernateNonEntityMetadata(SessionFactory sessionFactory, Type type,
	...
	public Object getPropertyValue(Object object, String property) {
		...
		if (i == -1) {
			...
			return ((ComponentType) type).getPropertyValue(object, i,
					EntityMode.POJO);
		}
	}
	...
	public boolean isString() {
		...
		return types.length == 1
				&& (types[0] == java.sql.Types.VARCHAR || types[0] == java.sql.Types.CHAR);
	}
